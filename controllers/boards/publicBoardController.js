...
async function allPlayersPlayed(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en allPlayersPlayed public"
            })
        }
...
async function eliminate(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en eliminate public"
            })
...
async function eliminatePlayers(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en eliminatePlayers public"
            })
        }
...
async function seeAbsents(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en seeAbsents public"
            })
        }
...
async function isFull(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en isFull public"
            })
        }
...
async function finishBoard(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en finishBoard public"
            })
        }
...
async function newMessage(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en newMessage public"
            })
        }
...
async function leaveBoardPriv(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en leaveBoardPriv public"
            })
        }
        ...
        // Se elimina el usuario de la lista de jugadores en espera para que
        // pueda solicitar jugar otra partida
        res = await MatcherController.eliminateWaitingUsers({ body: {playersToDelete: [userId]}})
        if (res.status === "error") return res
...
async function restBet(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en restBet public"
            })
        }
...
const leaveBoard = async (req, res) => {
    ...
    try {
        ...
        if (!board) {
            return res.status(404).json({
                status: "error",
                message: "Mesa no encontrada en leaveBoard public"
            })
        }
...
async function resume(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en resume public"
            })
        }
...
const pause = async (req, res) => {
    ...
    try {
        ...
        if (!board) {
            return res.status(404).json({
                status: "error",
                message: "Mesa no encontrada en pause public"
            })
        }
...
async function plays(req) {
    ...
    try {
        ...
        if (!board) {
            return ({
                status: "error",
                message: "Mesa no encontrada en plays public"
            })
        }
